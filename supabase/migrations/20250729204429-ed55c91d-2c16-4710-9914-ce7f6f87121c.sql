...
-- Create policies for arquetipos (public read)
CREATE POLICY "Anyone can view arquetipos" 
...
-- Insert the 12 arquetipos
INSERT INTO public.arquetipos (nome, entusiasta, sensivel, mente_aberta, organizado, tecnico, descricao, carreiras_favoraveis, cursos_sugeridos, cursos_indicados) VALUES
...
CREATE TRIGGER update_arquetipos_updated_at
  BEFORE UPDATE ON public.arquetipos
  FOR EACH ROW
